...
<div class="form-group col-md-12">
    <label for="doc_benefits">Документы, представляющие право на льготы</label>
    <input type="text" class="form-control" id="doc_benefits" name="doc_benefits"
           placeholder="Документы, представляющие право на льготы"
...
<div class="form-group col-md-12">
    ...
    <label for="checkbox_obsaga">Нуждаюсь в общежитии</label>
</div>
<div class="form-group col-md-12">
