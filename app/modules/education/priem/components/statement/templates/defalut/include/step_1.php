...
<div class="form-group col-md-12">
    ...
    <div class="form-group col-md-12">
        ...
        <select id="entrant_status" name="entrant_status" class="ep_addres">
            <option value="0" <?php if (isset($entrant) && $entrant->entrant_status == '0'): ?> selected<?php endif ?>>Пустая</option>
            <option value="1" <?php if (isset($entrant) && $entrant->entrant_status == '1'): ?> selected<?php endif ?>>Загрузка документов</option>
            <option value="2" <?php if (isset($entrant) && $entrant->entrant_status == '2'): ?> selected<?php endif ?>>На обработке</option>
            <option value="3" <?php if (isset($entrant) && $entrant->entrant_status == '3'): ?> selected<?php endif ?>>На изменении</option>
            <option value="4" <?php if (isset($entrant) && $entrant->entrant_status == '4'): ?> selected<?php endif ?>>Завершена</option>
        </select>
    </div>
<?php endif ?>